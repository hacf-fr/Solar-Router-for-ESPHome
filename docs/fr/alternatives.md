...
* [Routeur Photovoltaïque](https://f1atb.fr) d'**André**, routeur solaire multi-source qui a été la source d'inspiration de **Solar-Router-for-ESPHome**
...
!!! note "Alternative manquante ?"
    N'hésitez pas à ouvrir une issue sur [GitHub](https://github.com/hacf-fr/Solar-Router-for-ESPHome/issues) et nous mettons à jour cette page avec cette alternative.
